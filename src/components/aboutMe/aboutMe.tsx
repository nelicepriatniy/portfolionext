...
function AboutMeBlock(props:any) {
  return ( 
    ...
    <div className={s.aboutMeBlock}>
        <p className={s.text}>
          В <span>2018</span> году я начал увлекаться разработкой небольших приложений. На тот момент первой серьезной задачей стала разработка <span>самописной системы авторизации.</span>
        </p>
        <p className={s.text}>
